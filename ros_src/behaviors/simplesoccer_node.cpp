#include "simplesoccer_node.hpp"

SimpleSoccerNode::SimpleSoccerNode( const std::string teamName,
        int uNum,
        const map<string, string>& namedParams_,
        const string& rsg_)
    : NaoBehaviorNode( teamName,
                   uNum,
                   namedParams_,
                   rsg_) {
}

void SimpleSoccerNode::beam( double& beamX, double& beamY, double& beamAngle ) {
...
SkillType SimpleSoccerNode::selectSkill() {
...
int SimpleSoccerNode::getPlayerClosestToBall() {
...
map<int, Role> SimpleSoccerNode::getAgentRoles() {
...
VecPosition SimpleSoccerNode::getSpaceForRole(Role role) {
...
double SimpleSoccerNode::getAgentDistanceToRole(int uNum, Role role) {
    VecPosition temp;
...
SkillType SimpleSoccerNode::goToSpace(VecPosition space) {
...
SkillType SimpleSoccerNode::watchPosition(VecPosition pos) {
