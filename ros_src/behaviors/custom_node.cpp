...
CustomBehaviorNode::CustomBehaviorNode( const std::string teamName,
        int uNum,
...
void CustomBehaviorNode::beam( double& beamX, double& beamY, double& beamAngle ) {
...
SkillType CustomBehaviorNode::selectSkill() {
...
int CustomBehaviorNode::getPlayerClosestToBall() {
...
map<int, Role> CustomBehaviorNode::getAgentRoles() {
...
VecPosition CustomBehaviorNode::getSpaceForRole(Role role) {
...
double CustomBehaviorNode::getAgentDistanceToRole(int uNum, Role role) {
    VecPosition temp;
...
SkillType CustomBehaviorNode::goToSpace(VecPosition space) {
...
SkillType CustomBehaviorNode::watchPosition(VecPosition pos) {
